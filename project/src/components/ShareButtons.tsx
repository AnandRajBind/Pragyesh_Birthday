...
export default function ShareButtons() {
  ...
  const shareText = "Join me in wishing Pragyesh Kumar Seth a very Happy Birthday! 🎉";
  ...
  const shareLinks = [
    ...
    },
    {
      name: 'Email',
      icon: Mail,
      url: `mailto:?subject=${encodeURIComponent("Birthday Wishes for Pragyesh")}&body=${encodeURIComponent(shareText + '\n\n' + shareUrl)}`,
