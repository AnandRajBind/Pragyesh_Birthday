...
export default function BirthdayTimeline() {
  ...
  const timelineEvents: TimelineEvent[] = [
    ...
    },
    {
      ...
      description: "Accomplished something really special that brought so much joy and pride.",
      icon: "⭐",
    ...
    },
    {
      id: 5,
      year: 2021,
      title: "Birthday During Challenging Times",
      description: "Even during difficult times, found ways to celebrate and spread joy to others.",
      icon: "💪",
    ...
    },
    {
      ...
      year: 2020,
      title: "New Beginning",
      description: "Started something new and exciting that opened up amazing opportunities.",
      icon: "🌟",
