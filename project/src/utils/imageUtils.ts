...
export const DEFAULT_BIRTHDAY_IMAGE = '/images/pragyesh.jpg';
...
export const getOptimizedImageSrc = (src: string, _size: 'small' | 'medium' | 'large' | 'hero'): string => {
  // For now, return the original src
  // In a real application, you might want to use different sizes or image optimization services
  return src;
};

export const generateImageAlt = (name: string = 'Pragyesh Kumar Seth'): string => {
